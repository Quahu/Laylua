...
/// <summary>
///     Defines existing <see cref="ILuaLibrary"/> implementations.
/// </summary>
/// <seealso cref="Standard"/>
public unsafe class LuaLibraries
{
    /// <summary>
    ...
    public static class Standard
    {
        ...
        /// </summary>
        public static ILuaLibrary Base { get; } = new BaseLibrary("basic", "assert", "collectgarbage", "dofile", "error", "getmetatable", "ipairs", "loadfile", "load",
        ...
        /// </summary>
        public static ILuaLibrary Coroutine { get; } = new RequireLibrary(LUA_COLIBNAME, luaopen_coroutine);

        /// <summary>
        ///     Gets a library that opens the coroutine Lua standard library.
        ///     <para> See <a href="https://www.lua.org/manual/5.4/manual.html#6.6">Lua manual</a>. </para>
        /// </summary>
        public static ILuaLibrary Table { get; } = new RequireLibrary(LUA_TABLIBNAME, luaopen_table);
        ...
        /// </summary>
        public static ILuaLibrary IO { get; } = new RequireLibrary(LUA_IOLIBNAME, luaopen_io);
        ...
        /// </summary>
        public static ILuaLibrary OS { get; } = new RequireLibrary(LUA_OSLIBNAME, luaopen_os);
        ...
        /// </summary>
        public static ILuaLibrary String { get; } = new RequireLibrary(LUA_STRLIBNAME, luaopen_string);
        ...
        /// </summary>
        public static ILuaLibrary UTF8 { get; } = new RequireLibrary(LUA_UTF8LIBNAME, luaopen_utf8);
        ...
        /// </summary>
        public static ILuaLibrary Math { get; } = new RequireLibrary(LUA_MATHLIBNAME, luaopen_math);
        ...
        /// </summary>
        public static ILuaLibrary Debug { get; } = new RequireLibrary(LUA_DBLIBNAME, luaopen_debug);
        ...
        /// </summary>
        public static ILuaLibrary Package { get; } = new RequireLibrary(LUA_LOADLIBNAME, luaopen_package, "require");
        ...
        /// </returns>
        public static IEnumerable<ILuaLibrary> EnumerateAll()
        {
            yield return Base;
        ...
        private class BaseLibrary : ILuaLibrary
        {
            public string Name { get; }

            IReadOnlyList<string> ILuaLibrary.Globals => _globals;
            ...
            public virtual void Open(Lua lua, bool leaveOnStack)
            {
            ...
            public virtual void Close(Lua lua)
            {
        ...
        private sealed class RequireLibrary : BaseLibrary
        {
            ...
            public override void Open(Lua lua, bool leaveOnStack)
            {
                lua.Stack.EnsureFreeCapacity(1);
            ...
            public override void Close(Lua lua)
            {
                base.Close(lua);
